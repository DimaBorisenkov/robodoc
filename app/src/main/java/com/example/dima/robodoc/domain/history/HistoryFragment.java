    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_sortByDate:
                /*patientsAdapter = new PatientsAdapter(historyPresenter.sort(true, realmHelper), getContext(), recyclerView);
                recyclerView.setAdapter(patientsAdapter);*/
                return true;
            case R.id.action_sortByStatus:
                /*patientsAdapter = new PatientsAdapter(historyPresenter.sort(false, realmHelper), getContext(), recyclerView);
                recyclerView.setAdapter(patientsAdapter);*/
                return true;
        }
